  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>המטלה תחל במסך מלא כשתלחצ/י על הכפתור מטה.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">התחל במטלה</button></div>');
